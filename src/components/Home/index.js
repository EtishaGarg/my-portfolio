...
const Home = () => {
    ...
    return(
        <div className='flex-col justify-center items-center'>
            ...
            <div className='flex justify-center items-center py-7 px-20 bg-violet-300 mt-8'>
                <div className='bg-violet-300 flex flex-col items-center m-auto px-[100px] py-[25px]'>
                    ...
                    <form onSubmit={handleSubmit} className='flex justify-center items-center gap-2 mt-2'>
                        ...
                        <button className='bg-violet-500 px-2 py-1 text-xl font-bold rounded shadow-xl hover:ring-2 text-white'>Subscribe</button>
                    </form>
                </div>
            </div>
