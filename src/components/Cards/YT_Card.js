...
const YT_Card = (props) => {
    return (
        <div className='h-[450px] p-10 bg-violet-300 rounded-xl'>
            <div className='flex-col text-center h-[380px] bg-white shadow-xl rounded-xl overflow-hidden'>
                ...
                <a className='bg-violet-300 px-3 py-2 text-2xl font-bold rounded shadow-xl hover:ring-2 hover:text-white' href={props.link} target="_blank">Watch on Youtube</a>
            </div>
        </div>
    )
}
